...
public class EmailSmsTicketPage {
	WebDriver driver;

	public EmailSmsTicketPage(WebDriver driver) {
		PageFactory.initElements(driver, this);
		this.driver = driver;
	}
	
	String pageTitle="SmsAndEmailTicket".toLowerCase();
	...
	public void fill_ticketNo(String ticketNo) {
	 ...
	 public boolean validateNavigationToPrintTicketPage() {
		if(driver.getCurrentUrl().toLowerCase().contains("printticket"))
			return true;
		else
			return false;
