...
public class TestsType_EmailSmsTicket extends Test_BaseTest{
	...
	public void emailSmsTicket_validtin_validemail() throws IOException {
		...
		if(test_run.get("emailSmsTicket_validtin_validemail").equals("y")) {
			...
			driver.quit();
			//_________________________________________________
			testsheet.getRow(13).getCell(2).setCellValue("pass");
		}
		else {
			testsheet.getRow(13).getCell(2).setCellValue("not defined");
		}
	...
	public void emailSmsTicket_invalidtin_invalidemail() throws IOException {
		...
		if(test_run.get("emailSmsTicket_invalidtin_invalidemail").equals("y")) {
			//_________________________________________________
			initializeWebDriver();
			...
			driver.quit();
			//_________________________________________________
			testsheet.getRow(14).getCell(2).setCellValue("pass");
		}
		else {
			testsheet.getRow(14).getCell(2).setCellValue("not defined");
		}
	...
	public void emailSmsTicket_invalidtin_validemail() throws IOException {
		...
		if(test_run.get("emailSmsTicket_invalidtin_validemail").equals("y")) {
			//_________________________________________________
			initializeWebDriver();
			...
			driver.quit();
			//_________________________________________________
			testsheet.getRow(15).getCell(2).setCellValue("pass");
		}
		else {
			testsheet.getRow(15).getCell(2).setCellValue("not defined");
		}
	...
	public void emailSmsTicket_validtin_invalidemail() throws IOException {
		...
		if(test_run.get("emailSmsTicket_validtin_invalidemail").equals("y")) {
			//_________________________________________________
			initializeWebDriver();
			...
			driver.quit();
			//_________________________________________________
			testsheet.getRow(16).getCell(2).setCellValue("pass");
		}
		else {
			testsheet.getRow(16).getCell(2).setCellValue("not defined");
		}
